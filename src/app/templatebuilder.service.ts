...
export class TemplatebuilderService {
  ...
  combineFormDataObserver = new Subject();
  public combineFormDataSubscriber$ = this.combineFormDataObserver.asObservable();
  ...
  emitCombineFormData(data: any) {
    this.combineFormDataObserver.next(data);
  }
